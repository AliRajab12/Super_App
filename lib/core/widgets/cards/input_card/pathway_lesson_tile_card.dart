...
class PathwayLessonTileCard extends StatefulWidget {
  final Input input;
  final VoidCallback onTap;
  final Widget? trailing;

  const PathwayLessonTileCard({
    super.key,
    required this.input,
    required this.onTap,
    this.trailing,
  ...
  @override
  State<PathwayLessonTileCard> createState() => _PathwayLessonTileCardState();
}

class _PathwayLessonTileCardState extends State<PathwayLessonTileCard> {
  @override
