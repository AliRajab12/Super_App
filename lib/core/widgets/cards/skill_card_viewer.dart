...
class SkillCardViewer extends StatelessWidget {
  final Tag skill;
  final bool isSaving;
...
class SkillShimmerCardViewer extends StatelessWidget {
  const SkillShimmerCardViewer({Key? key}) : super(key: key);
