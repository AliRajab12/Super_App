...
class SomiHomeDetailScreen extends StatefulWidget {
  final String name;
  final String brand;
  ...
  @override
  SomiHomeDetailScreenState createState() => SomiHomeDetailScreenState();
}

class SomiHomeDetailScreenState extends State<SomiHomeDetailScreen> {
  @override
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Center(
                          child: Image.asset('images/active-saved.png'),
                        ),
                      ),
                    ],
                  ),
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text(widget.speed, style: kService),
                              const SizedBox(height: 3),
                              Text(
                                'Max. Speed',
                                style: kService.copyWith(
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 3),
                              Text(widget.seats, style: kService),
                              const SizedBox(height: 3),
                              Text(
                                'Seats',
                                style: kService.copyWith(
                          ...
                          Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Image.asset('images/engine.png'),
                              const SizedBox(height: 3),
                              Text(widget.engine, style: kService),
                              const SizedBox(height: 3),
                              Text(
                                'Engine',
                                style: kService.copyWith(
