...
class AgoraFullPage extends StatefulWidget {
  const AgoraFullPage({super.key});

  @override
  State<AgoraFullPage> createState() => _MyAppState();
}

class _MyAppState extends State<AgoraFullPage> {
  bool _isLogin = false;
  bool _isInChannel = false;
  LocalInvitation? _localInvitation;
  RemoteInvitation? _remoteInvitation;

  final _userNameController = TextEditingController(text: 'User 1');
      ...
      children: <Widget>[
        Expanded(
          child: TextField(
            ...
            decoration: const InputDecoration(hintText: 'Input peer user id'),
          ),
        ),
        OutlinedButton(
