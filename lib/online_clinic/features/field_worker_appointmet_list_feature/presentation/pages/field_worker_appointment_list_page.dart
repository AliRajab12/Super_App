...
@RoutePage()
class FieldWorkerAppointmentListPage extends StatefulWidget {
  const FieldWorkerAppointmentListPage({super.key , required this.tabIndex , required this.priorityTabIndex});
  static const String route = '/fieldWorkerAppointmentListPage';
  final int tabIndex;
  final int priorityTabIndex;
  @override
  State<FieldWorkerAppointmentListPage> createState() =>
      _FieldWorkerAppointmentListPageState();
}

class _FieldWorkerAppointmentListPageState extends State<FieldWorkerAppointmentListPage>
  ...
  GlobalKey<FieldWorkerAppointmentListWithPriorityState> fieldWorkerAppointmentListWithPriorityStateKey = GlobalKey();
  ...
  void initState() {
    ...
    _tabController.addListener(() {
      ...
      fieldWorkerAppointmentListWithPriorityStateKey.currentState?.appointmentsFilter = appointmentsFilter;
      fieldWorkerAppointmentListWithPriorityStateKey.currentState?.setState(() {
      });
    });
  ...
  Widget build(BuildContext context) {
    ...
    return CustomBody(
      ...
      FieldWorkerAppointmentListWithPriority(
        key: fieldWorkerAppointmentListWithPriorityStateKey,
